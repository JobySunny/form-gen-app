...
export function TextBox(props) {
    ...
    const getClassName = (ele = '') => `${cn[`tbox${ele}`]} ${props.className}${ele}`;
    const onKeyUp = (e) => {
        if (props.onKeyUp)
            props.onKeyUp(e);
        onEnterKey(() => {
