...
export function PasswordBox(props) {
    ...
    const getClassName = (ele = '') => `${cn[`pbox${ele}`]} ${props.className}${ele}`;
    const onKeyUp = (e) => {
        if (props.onKeyUp)
            props.onKeyUp(e);
        onEnterKey(() => {
