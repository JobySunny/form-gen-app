...
import { getLabel, getFlexDirection, getMainClass, getLegendClass, getPaddingTop, getPaddingRight, getPaddingBottom, getPaddingLeft, } from './Fieldset.utils';
export function Fieldset(props) {
    ...
    return (_jsx(F, Object.assign({ pathId: props.pathId, path: props.path, style: value.style, title: value.title, mainClass: value.mainClass, legendStyle: value.legendStyle, legendClass: value.legendClass }, { children: props.children })));
}
