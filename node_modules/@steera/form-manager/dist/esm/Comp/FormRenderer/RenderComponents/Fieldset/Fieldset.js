...
export function Fieldset(props) {
    ...
    return (_jsx(F, Object.assign({ style: value.style, title: value.title, mainClass: value.mainClass, legendStyle: value.legendStyle, legendClass: value.legendClass }, { children: props.children })));
}
