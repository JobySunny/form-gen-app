...
const NumberBox_1 = require("../../../../Components/NumberBox");
...
function NumberBox(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(NumberBox_1.NumberBox, { id: props.id, label: props.label, name: props.name, value: value, className: props.className, required: props.required, min: props.min, max: props.max, invalidInputMessage: props.invalidInputMessage, disabled: props.disabled, placeholder: props.placeholder, onChange: onChange }));
}
