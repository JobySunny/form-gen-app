...
const PasswordBox_1 = require("../../../../Components/PasswordBox");
...
function PasswordBox(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(PasswordBox_1.PasswordBox, { id: props.id, label: props.label, name: props.name, value: value, onChange: onChange, pattern: props.pattern, className: props.className, required: props.required, minLength: props.minLength, maxLength: props.maxLength, invalidInputMessage: props.invalidInputMessage, isSubmitted: props.isSubmitted, disabled: props.disabled, placeholder: props.placeholder }));
}
