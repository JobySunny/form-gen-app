...
function PasswordBox(props) {
    ...
    const getClassName = (ele = '') => `${PasswordBox_module_scss_1.default[`pbox${ele}`]} ${props.className}${ele}`;
    const onKeyUp = (e) => {
        if (props.onKeyUp)
            props.onKeyUp(e);
        onEnterKey(() => {
