...
const EmailBox_module_scss_1 = __importDefault(require("./EmailBox.module.scss"));
function EmailBox(props) {
    ...
    const getClassName = (ele = '') => `${EmailBox_module_scss_1.default[`ebox${ele}`]} ${props.className}${ele}`;
    const onKeyUp = (e) => {
        if (props.onKeyUp)
            props.onKeyUp(e);
        onEnterKey(() => {
