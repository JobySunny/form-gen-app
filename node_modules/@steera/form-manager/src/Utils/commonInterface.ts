...
export enum FormGeneratorComponentTypes {
  ADD_NEW = 'ADD_NEW',
  FLEX_ROW = 'FLEX_ROW',
  EMAIL_BOX = 'EMAIL_BOX',
 ...
 */
export enum FormRendererComponentTypes {
  FLEX_ROW = 'FLEX_ROW',
  EMAIL_BOX = 'EMAIL_BOX',
  FLEX_COLUMN = 'FLEX_COLUMN',
  PASSWORD_BOX = 'PASSWORD_BOX',
 ...
 */
export interface FormRendererTemplateElement
  extends Omit<FormGeneratorTemplateElement, 'type' | 'children'> {
  /**
   * Type of component to show in Element
   */
